...
def main():
    ...
    # Test 200 OK
    cmd_200 = f'curl -v http://127.0.0.1:8080/test.html'
    run_curl_command(cmd_200, "Test 200 OK")
    
    # Test 304 Not Modified
    # Conditional GET        working fine in terminal
    cmd_304 = f'curl.exe -v -H "If-Modified-Since: Wed, 23 Oct 2024 07:28:00 GMT" http://localhost:8080/test.html'
    run_curl_command(cmd_304, "Test 304 Not Modified")

    # Test 400 Bad Request
    cmd_400 = f'curl -v http://127.0.0.1:8080/test..html'
    run_curl_command(cmd_400, "Test 400 Bad Request")
    
    # Test 404 Not Found
    cmd_404 = f'curl -v http://127.0.0.1:8080/test.htm'
    run_curl_command(cmd_404, "Test 404 Not Found")
    
    # Test 501 Not Implemented
    cmd_501 = f'curl.exe -X POST -v http://localhost:8080/test.html'
